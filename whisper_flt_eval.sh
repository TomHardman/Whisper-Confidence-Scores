...
#python3 /scratches/dialfs/alta/th624/exp-th624/Whisper_flt/whisper_finetune.py --outdir  prompt0_lr1e-5_lower --eval_list_file /scratches/dialfs/alta/th624/exp-th624/data/Linguaskill/flt/test_single_flt.tsv --eval_dataset_name test --stage evaluate --model small.en